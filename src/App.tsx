...
function RealPawn({attackProgress=0,attackAngle=0,travel=[0,0,0],dark=false,attack=false}:{attackProgress?:number,attackAngle?:number,travel?:[number,number,number],dark?:boolean,attack?:boolean}){
 ...
 return <group ref={root} scale={.52} position={[0,.02,0]}><primitive object={model}/><group position={[0,.85,.08]} rotation={[Math.PI/2,0,0]}><mesh><cylinderGeometry args={[.018,.018,.72,8]}/><meshStandardMaterial color={dark?'#d7b35a':'#caa13e'} metalness={.8}/></mesh><mesh position={[0,.39,0]}><coneGeometry args={[.055,.16,8]}/><meshStandardMaterial color={dark?'#b8bcc8':'#ece5d2'} metalness={.7}/></mesh></group><group position={[0,.68,-.22]} rotation={[0,0,0]}><mesh rotation={[0,0,0]} scale={[.62,1,1]}><planeGeometry args={[.9,.95,8,8]}/><meshStandardMaterial color={dark?'#171922':'#3b3030'} metalness={.15} roughness={.8} side={2} transparent opacity={.94}/></mesh><mesh position={[0,.36,-.015]} rotation={[0,0,0]} scale={[.55,.32,1]}><planeGeometry args={[.9,.55,6,6]}/><meshStandardMaterial color={dark?'#252735':'#5a3b35'} metalness={.1} roughness={.9} side={2} transparent opacity={.92}/></mesh></group></group>;
}
